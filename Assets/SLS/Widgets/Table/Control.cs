...
namespace SLS.Widgets.Table {
  public class Control {
    ...
    public void SetLayoutVertical() {
      ...
      this.table.horScrollerRt.offsetMin = new Vector2(0, useFooterH);
      if(this.table.verScrollerRt.gameObject.activeInHierarchy)
        this.table.horScrollerRt.offsetMax = new Vector2(this.table.scrollBarSize * -1, useFooterH + this.table.scrollBarSize);
      else
        this.table.horScrollerRt.offsetMax = new Vector2(0, useFooterH + this.table.scrollBarSize);
      ...
      if(this.table.horScrollerRt.gameObject.activeInHierarchy)
        this.table.verScrollerRt.offsetMin = new Vector2(this.table.scrollBarSize * -1, useFooterH + this.table.scrollBarSize);
      else
        this.table.verScrollerRt.offsetMin = new Vector2(this.table.scrollBarSize * -1, useFooterH);
      this.table.verScrollerRt.offsetMax = new Vector2(0, (useHeaderH) * -1f);
      // because our scrollrect for some reason does wierd scaling
          ...
          if(row.datum.isHeader) {
            ...
            cell.SetContentSizeDelta(new Vector2(this.table.columns[i].safeWidth,
                                                 Mathf.Max(row.datum.SafeCellHeight(),
                                                           this.table.minRowHeight - this.table.rowVerticalSpacing)));
          }
