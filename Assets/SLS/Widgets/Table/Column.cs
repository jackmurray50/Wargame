...
namespace SLS.Widgets.Table {
  public class Column {
    ...
    public Color headerTextColorOverride {
      get { return this._headerTextColorOverride.HasValue ? this._headerTextColorOverride.Value : this.table.headerTextColor; }
      set { this._headerTextColorOverride = value; }
    }
    ...
    protected DataType _dataType = DataType.TEXT;
