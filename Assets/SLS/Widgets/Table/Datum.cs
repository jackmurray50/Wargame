...
namespace SLS.Widgets.Table {
  public class Element {
    ...
    public string value {
      ...
      set {
        this._value = value;
        this.datum.animationStartTime = DateTime.Now.Ticks * Table.TicksToSecs;
  ...
  public class Datum {
    ...
    public bool isDirty {
      ...
      set {
        ...
        this._isDirty = value;
        if(this._isDirty) {
          this.revision = DateTime.Now.Ticks * Table.TicksToSecs;
        }
  ...
  public class TableDatumList: IEnumerable<Datum> {
    ...
    public float safeTempRowHeight {
      get {
        ...
        if(!this._avgHeight.HasValue && this.safeHeightSum == 99.99f) { }
        ;
    ...
    public void Add(Datum item, bool finishAfterAdd = true) {
      ...
      item.animationStartTime = DateTime.Now.Ticks * Table.TicksToSecs;
      if(finishAfterAdd) {
        this.FinishDataChange();
      }
    }
    ...
    public Datum this[int index] {
      ...
      set {
        ...
        if(index >= 0 && index < this.count) {
          ...
          value.animationStartTime = DateTime.Now.Ticks * Table.TicksToSecs;
          this.FinishDataChange();
        }
      }
    }
